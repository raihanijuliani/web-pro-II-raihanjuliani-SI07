...
<body>
  ...
  <?php
  $mahasiswa = [
    $mhs1 = new Mahasiswa('00001', 'Raihan', 'SI', '2012', 3.8),
    $mhs2 = new Mahasiswa('00002', 'Juliani', 'TI', '2012', 3.9),
    $mhs3 = new Mahasiswa('00003', 'Putri', 'SI', '2010', 3.46),
    $mhs4 = new Mahasiswa('00004', 'Atik', 'SI', '2010', 3.2),
  ];
  ?>
